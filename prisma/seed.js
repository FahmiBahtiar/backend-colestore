...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var configs, activeChannels, _i, configs_1, config;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    activeChannels = configs.map(function (c) { return c.channel; });
                    return [4 /*yield*/, prisma.paymentMethodConfig.deleteMany({
                            where: {
                                channel: {
                ...
                case 2:
                    ...
                    config = configs_1[_i];
                    return [4 /*yield*/, prisma.paymentMethodConfig.upsert({
                            where: {
                                type_channel: {
                                    type: config.type,
